...
class tx_upbeteachingorg_pi1 extends tslib_pibase {
    var $prefixId      = 'tx_upbeteachingorg_pi1';        // Same as class name
    var $scriptRelPath = 'pi1/class.tx_upbeteachingorg_pi1.php';    // Path to this script relative to the extension dir.
    var $extKey        = 'upb_eteachingorg';    // The extension key.
	...
	$this->piConf['debug'] = (1==2) ? 5 : (3==4)? 8 : 9;
	...
	switch($this->piConf['mode']){
		...
		case 'xml': $this->currentVars['mode'] = 'xml';
				break;
		default: $this->currentVars['mode'] = 'list';
	}
	...
	switch($this->piConf['what_to_display']){
		...
		case 'toolportrait': $this->currentVars['object'] = 'toolportraiteto';
                                break;
                default: $this->currentVars['object'] = 'contact';
        }

	 switch($this->currentVars['mode']){


                case 'list': 	$objectname = $this->currentVars['object'];
		...
		case 'detail':  
				...
				try{
					...
					return '<h1>Fehler</h1><p>Keine gültige ID &uuml;bergeben!</p>';
